...
var VirtualScroll = (function(document) {
  ...
  var mouseMult   = 0.0005;
  var firefoxMult = 0.0005;
  var safariMult  = 0.300;
  ...
  var onWheel = function(e) {
    ...
    if(isFirefox && e.deltaMode == 1) {
      ...
      event.deltaX *= safariMult;
      event.deltaY *= safariMult;
    } else {
